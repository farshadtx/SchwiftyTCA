...
let apolloConfigDirectoryPath = projectDirectoryURL.appendingPathComponent("SchwiftyTCA/Data/Core").path
let apolloCliExecutablePath = projectDirectoryURL.appendingPathComponent("SchwiftyTCA/Data/Core/apollo-ios-cli").path
